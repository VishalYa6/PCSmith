...
const links = [
  {name: 'Home' , href: '/'},
  {name: 'PC Components' , href: '/PC_Components'},
  {name: 'Custom PC' , href: '/Custom_PC'},
  {name: 'Advance PC' , href: '/Advance_PC'},
]
    ...
    return (
      <header className="mb-8 border-b">
        <div className="flex items-center justify-between mx-auto max-w-2xl px-4 sm:px-6 lg:max-w-7xl">
         <Link href="/">
             <h1 className="text-2xl md:text-4xl font-bold">PC <span className="text-primary">Smith</span>
             </h1>
         </Link>
